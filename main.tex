...
\newtcolorbox{InvisibleCodeBox}{
    breakable=false,
    enhanced,
    colback=white,      % background = full white (blend with page)
    colframe=white,     % border = white (invisible)
    boxrule=0pt,        % no border line
    arc=0mm,            % square corners (no visible edges)
    left=0mm,           % no padding on left
    right=0mm,          % no padding on right
    top=0mm,
    bottom=0mm,
    enlarge top by=0mm,
    enlarge bottom by=0mm,
    boxsep=0pt,         % zero spacing
}
...
% ---------------------------------------------------------------------------------------------
\titulo{PhotoGraph: Uma Aplicação para Edição de Imagens Baseada em Nodes}
\autor{Matheus da Silva Correa Motizuki}
\local{Teresópolis}
\data{\the\year}
\orientador{Victor de Almeida Thomaz D.Sc.}
...
\include{src/fundamentacao}

%Capítulo 0X - Trabalhos Relacionados
\include{src/relacionados}
