...
O MS Paint é um editor e criador de imagens e desenhos tradicional, integrado ao sistema operacional Windows desde suas primeiras versões. É um software simples, gratuito e voltado para tarefas básicas de edição e criação de imagens. 
